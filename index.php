            ...
            <div class="container-fluid" >
                <div id="carousel_action" class="carousel slide carousel-fade" data-ride="carousel_action"   >
                  ...
                  if ($response){
                      ...
                      $items = 1; $rowcount = 1; $counter = 0; $active = true;
                      while ($row = mysqli_fetch_assoc($response)) {
                            ...
                            if ($items == 1) {
                                ...
                                if ($rowcount == 1) {
                                    ...
                                    $items++; $rowcount++; $active = false; $counter++;
              ...
              <div class="container-fluid" >
                <div id="carousel_racing" class="carousel slide carousel-fade" data-ride="carousel_racing"   >
                  ...
                  if ($response1){
                      ...
                      $items2 = 1; $rowcount2 = 1; $counter2 = 0; $active2 = true;
                      while ($row2 = mysqli_fetch_assoc($response1)) {
                            ...
                            if ($items2 == 1) {
                                ...
                                if ($rowcount2 == 1) {
                                    ...
                                    $items2++; $rowcount2++; $active2 = false; $counter2++;
