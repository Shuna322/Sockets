...
<body class="s_layout_fixed">
    <nav class="navbar bg-light navbar_bg" style="padding: 0px;">
        ...
        <ul class="navbar-nav nav-fill w-100">
            <li class="nav-item">
                <a class="nav-link" href="index.php"><img src="img\kej.png" alt="Logo" class="mr-3" style="height:40px;"><img src="img\logo.png" alt="Logo" class="mr-3" style="height:45px;"></a>
            </li>
        </ul>
    </nav>
    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar_bg navbar-light " >
       ...
       <span class="navbar-toggler-icon" style="color:#ff0000"></span>
        ...
        <div class="collapse navbar-collapse navbar-nav justify-content-between align-items-center align-content-center" id="navbarSupportedContent">
            ...
            <div class="nav-item w-100 input-group mr-3 mb-1 mt-1">
                <form class="w-100" style="height:30px" action="search.php" method="get">
                    <div class="nav-item  input-group mr-3 mb-1 mt-1">

                        <input  type="text" name="searchbar" class="form-control" placeholder="Пошук" aria-label="Пошук" aria-describedby="basic-addon2">
            ...
            <div class="nav-item mb-1 mt-1 ">
                <a class="nav-link text-center" id="navbardrop" data-toggle="dropdown"><i class="far fa-user" style="font-size:50px; color:#87888e"></i></a>
                <div class="dropdown-menu dropdown-menu-right cartbg">
              ...
              if($status)
                {
                  echo '<h2 style="color:#ffffff"> Ви авторизувані як'. $_SESSION['email'].'<h2>
                  ...
                  if ($status2){
                    echo '<h2 style="color:#ffffff"> Ви авторизувались як'.$_SESSION['email'].'<h2>
                    <form role="form" action="logout.php" method="post" autocomplete="off">
                    <div class="col-lg-12">
                      <input type="submit" name="logout" id="logout-submit" class="btn btn-danger" value="Вийти з акаунту">
                    </div>
                  ...
                  else
                  {
                    echo '<form method="post" role="form" autocomplete="off">
                      <div class="form-group">
                        <label style="color:#ffffff" for="email">Електрона адреса</label>
                        <input type="text" name="email" id="email" tabindex="1" class="form-control" autocomplete="off">
                      </div>
                      <div class="form-group">
                        <label style="color:#ffffff" for="password">Пароль</label>
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-lg-6">
                            ...
                            <label style="color:#ffffff" for="register" id="registerLabel">Не маєте аккаунта ?</label>
                          </div>
                          <div class="col-lg-6">
                            <input style="color:#ffffff" type="checkbox" tabindex="4" name="remember" id="remember">
                            <label style="color:#ffffff" for="remember" id="rememberLabel">Запам`ятати мене</label>
                          </div>
                          <div class="col-lg-12">
